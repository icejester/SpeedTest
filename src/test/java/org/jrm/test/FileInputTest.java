...
class FileInputTest {
    ...
    void setUp()
    {
        fi = new FileInput("./src/test/java/org/jrm/test/FileInputTest.java");
    }
    ...
    @Test
    void readFile() { assertEquals("package org.jrm.t", fi.readFile().substring(0,17), "Substring 17 of this file should contain import statement"); }
